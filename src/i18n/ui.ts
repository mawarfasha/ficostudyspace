...
export const ui = {
	en: {
		...
		"hero.subtitle":
			"Ashav, my pretty, angelic, cutesy, gorgeous, beautiful, stunning, lovely, darling, sweet, adorable, precious, charming, enchanting, mesmerizing, irresistible, elegant, graceful, classy, chic, stylish, Let's study my love!",
