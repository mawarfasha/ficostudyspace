...
export const ui = {
	en: {
		...
		"hero.subtitle":
			"Ashav, my pretty, angelic, cutesy, gorgeous, beautiful, stunning, lovely, darling, sweet, adorable, precious, charming, enchanting, fine, mesmerizing, irresistible, graceful, classy, chic, stylish, girl!      Let's study my love!",
