...
export const ui = {
	en: {
		...
		homepage: "Homepage",
		tagline:
			"hi ashav :3, this website is still in progress, only the camera and timer is working, i haven't figure out the time lapsing yet, but i will soon! If you want to use this unfinished project, feel free too! I love you so much, I'm wishing you the best always my love!\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
		"projects.yours": "Your project",
		"projects.see": "See project",
		"hero.title.main": "Ashav! Let's",
		"hero.title.1": "study",
		"hero.title.2": "eat this up",
		"hero.title.3": "do this shit",
		"hero.title.4": "LOCK IN!",
		"hero.subtitle":
			"Ashav, my pretty, angelic, cutesy, gorgeous, beautiful, stunning, lovely, darling, sweet, adorable, precious, charming, enchanting, fine, hot, mesmerizing, irresistible, graceful, classy, chic, stylish, girl!      Let's study my love!",
